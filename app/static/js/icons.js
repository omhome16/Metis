...
const P = {
  ...
  gear: '<circle cx="12" cy="12" r="3"/><path d="M12 2.8l.9 2.3a8 8 0 0 1 2.9 1.7l2.4-.6 1.6 2.8-1.8 1.7a8 8 0 0 1 0 3.4l1.8 1.7-1.6 2.8-2.4-.6a8 8 0 0 1-2.9 1.7l-.9 2.3h-2.9l-.9-2.3a8 8 0 0 1-2.9-1.7l-2.4.6-1.6-2.8 1.8-1.7a8 8 0 0 1 0-3.4L3.3 9.4l1.6-2.8 2.4.6a8 8 0 0 1 2.9-1.7l.9-2.3z"/>',
  book: '<path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/>',
  logout: '<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><path d="M16 17l5-5-5-5"/><path d="M21 12H9"/>',
  user: '<circle cx="12" cy="8" r="4"/><path d="M4 21c1.5-3.5 4.5-5 8-5s6.5 1.5 8 5"/>',
  note: '<path d="M5 4h14v13l-4 4H5z"/><path d="M15 21v-4h4"/><path d="M9 9h6M9 13h4"/>',
  download: '<path d="M12 4v11M7 10.5l5 5 5-5"/><path d="M4 20h16"/>',
  link: '<path d="M10 14a5 5 0 0 0 7.5.5l2-2a5 5 0 0 0-7-7l-1.2 1.1"/><path d="M14 10a5 5 0 0 0-7.5-.5l-2 2a5 5 0 0 0 7 7l1.2-1.1"/>',
  shield: '<path d="M12 3l7.5 3v5.5c0 4.6-3.2 7.9-7.5 9.5-4.3-1.6-7.5-4.9-7.5-9.5V6z"/>',
  zap: '<path d="M13 2.5L4.5 13.5H11l-1 8 8.5-11H12z"/>',
  filter: '<path d="M4 5h16l-6.5 7.5V19l-3 1.5v-8z"/>',
  info: '<circle cx="12" cy="12" r="9"/><path d="M12 11v5"/><circle cx="12" cy="8" r="0.4"/>',
